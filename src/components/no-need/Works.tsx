        ...
        <div className={styles.slide}>
            <div className={styles.container}>
                <div className={styles.img}>
                    <img src={require('../../assets/film.jpg')} alt="niako" style={{objectFit: 'contain'}}/>
                </div>
                <div className={styles.info}>
                    <h1>ნიას ნახატები</h1>
                    <h2>თუ საკუთარი შესაძლებლობის დაჩმორება გსურთ, მაშინ იხილე <span>ულამაზესი ნაშრომები</span></h2>
                    <button>
