        ...
        <div className={styles.slide}>
            <div className={styles.container}>
                <div className={styles.img}>
                    <img src={require('../../assets/girl.png')} alt="niako" />
                </div>
                <div className={styles.info}>
                    <h1>ნია და Cinematography</h1>
                    <h2>თუ გამოხვედი პადვალიდან, მაშინ იხილე <span>საინტერესო მომენტები ფილმებიდან</span></h2>
                    <button>
                        <NavLink to={'/cinema'} className={styles.navlink}>
